...
type WideStruct struct {
	...
	F4  int `beve:"f4" json:"f4"`
	F5  int `beve:"f5" json:"f5"`
	F6  int `beve:"f6" json:"f6"`
	F7  int `beve:"f7" json:"f7"`
	F8  int `beve:"f8" json:"f8"`
	F9  int `beve:"f9" json:"f9"`
	F10 int `beve:"f10" json:"f10"`
	F11 int `beve:"f11" json:"f11"`
	F12 int `beve:"f12" json:"f12"`
	F13 int `beve:"f13" json:"f13"`
	F14 int `beve:"f14" json:"f14"`
	F15 int `beve:"f15" json:"f15"`
	F16 int `beve:"f16" json:"f16"`
	F17 int `beve:"f17" json:"f17"`
	F18 int `beve:"f18" json:"f18"`
	F19 int `beve:"f19" json:"f19"`
	F20 int `beve:"f20" json:"f20"`
	F21 int `beve:"f21" json:"f21"`
	F22 int `beve:"f22" json:"f22"`
	F23 int `beve:"f23" json:"f23"`
	F24 int `beve:"f24" json:"f24"`
	F25 int `beve:"f25" json:"f25"`
	F26 int `beve:"f26" json:"f26"`
	F27 int `beve:"f27" json:"f27"`
	F28 int `beve:"f28" json:"f28"`
	F29 int `beve:"f29" json:"f29"`
	F30 int `beve:"f30" json:"f30"`
	F31 int `beve:"f31" json:"f31"`
	F32 int `beve:"f32" json:"f32"`
	F33 int `beve:"f33" json:"f33"`
	F34 int `beve:"f34" json:"f34"`
	F35 int `beve:"f35" json:"f35"`
	F36 int `beve:"f36" json:"f36"`
	F37 int `beve:"f37" json:"f37"`
	F38 int `beve:"f38" json:"f38"`
	F39 int `beve:"f39" json:"f39"`
	F40 int `beve:"f40" json:"f40"`
	F41 int `beve:"f41" json:"f41"`
	F42 int `beve:"f42" json:"f42"`
	F43 int `beve:"f43" json:"f43"`
	F44 int `beve:"f44" json:"f44"`
	F45 int `beve:"f45" json:"f45"`
	F46 int `beve:"f46" json:"f46"`
	F47 int `beve:"f47" json:"f47"`
	F48 int `beve:"f48" json:"f48"`
	F49 int `beve:"f49" json:"f49"`
